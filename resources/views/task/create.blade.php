            ...
            <div class="content col-md-8">
                <div class="title"><h2>Add a Task</h2></div>
                 <form action="store" method="POST">
                   ...
                   @endif
                      <input type="text" class="form-control input{{ $errors->has('title') ? ' has-error' : '' }}" name="title" placeholder="Title of the Task">
                   @if ($errors->has('description'))
                         <span class="help-block">{{ $errors->first('description') }}
                   @endif
                      <input type="text" class="form-control input{{ $errors->has('description') ? ' has-error' : '' }}" name="description" placeholder="Description">
